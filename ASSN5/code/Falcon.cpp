...
bool Falcon::AskSkill()
{
	...
	cout << "라운드당 송골매의 살조 제한 횟수에 도달하였습니다." << endl;
	return false;
}
...
// Function to reset Falcon's kill chance per round
void Falcon::Reset_KillChance_PerRound()
{
	this->KillChance_PerRound = 1;
}